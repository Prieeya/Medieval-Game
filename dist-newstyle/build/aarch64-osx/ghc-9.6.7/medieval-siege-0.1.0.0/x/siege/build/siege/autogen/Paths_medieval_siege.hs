...
-- at runtime using the environment variable medieval_siege_bindir.
...
-- environment variable medieval_siege_libdir.
...
-- using the environment variable medieval_siege_dynlibdir.
...
-- runtime using the environment variable medieval_siege_datadir.
...
-- variable medieval_siege_libexedir.
...
-- using the environment variable medieval_siege_sysconfdir.
...
bindir     = "/Users/prieyadahal/.cabal/bin"
libdir     = "/Users/prieyadahal/.cabal/lib/aarch64-osx-ghc-9.6.7/medieval-siege-0.1.0.0-inplace-siege"
dynlibdir  = "/Users/prieyadahal/.cabal/lib/aarch64-osx-ghc-9.6.7"
datadir    = "/Users/prieyadahal/.cabal/share/aarch64-osx-ghc-9.6.7/medieval-siege-0.1.0.0"
libexecdir = "/Users/prieyadahal/.cabal/libexec/aarch64-osx-ghc-9.6.7/medieval-siege-0.1.0.0"
sysconfdir = "/Users/prieyadahal/.cabal/etc"

getBinDir     = catchIO (getEnv "medieval_siege_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "medieval_siege_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "medieval_siege_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "medieval_siege_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "medieval_siege_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "medieval_siege_sysconfdir") (\_ -> return sysconfdir)
